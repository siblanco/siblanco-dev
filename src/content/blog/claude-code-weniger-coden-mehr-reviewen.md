---
isDraft: false
title: "Claude Code: Weniger coden, mehr reviewen"
description: "Wie Claude Code meinen Alltag verändert hat, warum ich trotzdem noch selbst code — und warum Juniors es gerade schwer haben."
date: 2026-02-19
tags: ["ai", "devlife"]
---
...
Im [letzten Beitrag](https://siblanco.dev/blog/aider-mein-neuer-coding-begleiter-im-terminal) ging es um Aider. Ich war echt begeistert davon, vor allem vom Architect Mode. Aber kurz danach bin ich auf [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview) umgestiegen und seitdem nicht mehr zurück. Es hat sich einfach natürlicher angefühlt, der Workflow war runder und die Ergebnisse waren nochmal deutlich besser. Ich hab mich sofort wohlgefühlt damit.
...
Früher hat es mehr Spaß gemacht. Das pure Coden, Zeile für Zeile, dieses Flow-Gefühl wenn man drin, ist schon unschlagbar. Neovim Spaß habe ich aber immer noch viel.
Man muss mitgehen, sonst kann man nicht mithalten.
